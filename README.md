...
> Допустим есть несколько вариантов, Каждое следующее число должно быть в шаблоне минус ряд порядка регресса. Например, отсчет начался с 87, значит следующее число должно быть в шаблоне 86, потом 85 и т.д. Сортировать всех чисел, До тех пор, пока не найдем только один возможный вариант.
...
> От 99 до 1 за ≈60мс, с восемью сломанными датчиками и с созданием цифр с сломанными датчиками, (NUnit)
